                    ...
                    if isinstance(v, (list)):
                        for v1 in v:
                            if (v1 in obj[key] and k==key): #условия смежной вершины: 1) значение есть в словаре под номером родительской
                                ...
                                if v1 not in obj.keys() or len(obj[v1])==1: #убеждение, что это вершина крайняя или что связана лишь с одной
                                    obj[key].remove(v1)
                                my_code(obj, v1, list1,1)
        else: # пошел заново с первой вершины другие пути искать
            my_code(obj, list1[0], list1,1)
        n=0
